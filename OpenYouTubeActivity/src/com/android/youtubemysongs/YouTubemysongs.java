...
public class YouTubemysongs extends Activity {
	...
	private class QueryYouTubeTask extends AsyncTask<YouTubeId, ProgressUpdateInfo, Uri> {
		...
		protected Uri doInBackground(YouTubeId... pParams) {
			...
			try {
				...
				WifiManager lWifiManager = (WifiManager) YouTubemysongs.this.getSystemService(Context.WIFI_SERVICE);
				TelephonyManager lTelephonyManager = (TelephonyManager) YouTubemysongs.this.getSystemService(Context.TELEPHONY_SERVICE);
		...
		protected void onPostExecute(Uri pResult) {
			...
			try {
				...
				final MediaController lMediaController = new MediaController(YouTubemysongs.this);
				...
				mVideoView.setOnPreparedListener( new MediaPlayer.OnPreparedListener() {
					...
					public void onPrepared(MediaPlayer pMp) {
						if(isCancelled())
							return;
						YouTubemysongs.this.mProgressBar.setVisibility(View.GONE);
						YouTubemysongs.this.mProgressMessage.setVisibility(View.GONE);
					}
		...
		private void showErrorAlert() {
			...
			try {
				Builder lBuilder = new AlertDialog.Builder(YouTubemysongs.this);
		...
		protected void onProgressUpdate(ProgressUpdateInfo... pValues) {
			...
			YouTubemysongs.this.updateProgress(pValues[0].mMsg);
		}
